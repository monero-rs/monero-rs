...
/// A party waiting for the dealer to assign their position in the
/// aggregation.
...
/// A party which has committed to the bits of its value and is
/// waiting for the aggregated value challenge from the dealer.
...
/// A party which has committed to their polynomial coefficents and is
/// waiting for the polynomial challenge from the dealer.
